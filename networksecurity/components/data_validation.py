...
class DataValidation:
    ...
    def is_numerical_column_exist(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            missing_numerical_columns = [
                column for column in numerical_columns if column not in dataframe_columns
            ]
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            logging.info("Reading ingested train and test data")
            ...
            logging.info("Structural validation passed")
            drift_status = self.detect_dataset_drift(
                base_df=train_dataframe, current_df=test_dataframe
            )
            logging.info(f"Drift validation status: {drift_status}")
