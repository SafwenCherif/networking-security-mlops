...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        training pipeline constants and returns a Pipeline object.
        """
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            save_object(os.path.join("final_model", "preprocessor.pkl"), preprocessor_object)

            logging.info(
                f"Saved transformed train array: {self.data_transformation_config.transformed_train_file_path}"
            )
            logging.info(
                f"Saved transformed test array: {self.data_transformation_config.transformed_test_file_path}"
            )
            logging.info(
                f"Saved preprocessor object: {self.data_transformation_config.transformed_object_file_path}"
            )
